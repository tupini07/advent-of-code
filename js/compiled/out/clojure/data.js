...
return cljs.core.reduce.call(null,(function (result,p__38345){
...
var vec__38352 = clojure.data.diff.call(null,va,vb);
var a_STAR_ = cljs.core.nth.call(null,vec__38352,(0),null);
var b_STAR_ = cljs.core.nth.call(null,vec__38352,(1),null);
var ab = cljs.core.nth.call(null,vec__38352,(2),null);
...
var args38355 = [];
var len__25866__auto___38358 = arguments.length;
var i__25867__auto___38359 = (0);
while(true){
if((i__25867__auto___38359 < len__25866__auto___38358)){
args38355.push((arguments[i__25867__auto___38359]));

var G__38360 = (i__25867__auto___38359 + (1));
i__25867__auto___38359 = G__38360;
continue;
} else {
}
break;
...
break;
default:
throw (new Error([cljs.core.str("Invalid arity: "),cljs.core.str(args38355.length)].join('')));
...
var m__25455__auto__ = (clojure.data.equality_partition[goog.typeOf(x__25454__auto__)]);
if(!((m__25455__auto__ == null))){
return m__25455__auto__.call(null,x);
} else {
var m__25455__auto____$1 = (clojure.data.equality_partition["_"]);
...
var x__25454__auto__ = (((a == null))?null:a);
var m__25455__auto__ = (clojure.data.diff_similar[goog.typeOf(x__25454__auto__)]);
if(!((m__25455__auto__ == null))){
return m__25455__auto__.call(null,a,b);
} else {
var m__25455__auto____$1 = (clojure.data.diff_similar["_"]);
if(!((m__25455__auto____$1 == null))){
return m__25455__auto____$1.call(null,a,b);
} else {
...
return (function (){var G__38365 = (((clojure.data.equality_partition.call(null,a) instanceof cljs.core.Keyword))?clojure.data.equality_partition.call(null,a).fqn:null);
switch (G__38365) {
case "atom":
...
//# sourceMappingURL=data.js.map?rel=1481924990697