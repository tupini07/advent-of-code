...
var G__37748 = devtools.prefs.pref.call(null,v);
v = G__37748;
continue;
} else {
return v;
...
}catch (e37761){var e__35352__auto__ = e37761;
return false;
}})();
...
}catch (e37765){var e__35352__auto__ = e37765;
return false;
}})();
...
}catch (e37767){var e__35352__auto__ = e37767;
return false;
}}
}
});
...
var vec__37772 = devtools.munging.parse_constructor_info.call(null,constructor_fn);
var ns = cljs.core.nth.call(null,vec__37772,(0),null);
var name = cljs.core.nth.call(null,vec__37772,(1),null);
...
return cljs.core.some.call(null,(function (p1__37775_SHARP_){
return cljs.core._EQ_.call(null,devtools.formatters.helpers.pref.call(null,new cljs.core.Keyword(null,"more-marker","more-marker",-14717935)),p1__37775_SHARP_);
}),template);
});
...
//# sourceMappingURL=helpers.js.map?rel=1481854549113