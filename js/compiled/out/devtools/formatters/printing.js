...
var len__25866__auto___38640 = arguments.length;
var i__25867__auto___38641 = (0);
while(true){
if((i__25867__auto___38641 < len__25866__auto___38640)){
args__25873__auto__.push((arguments[i__25867__auto___38641]));

var G__38642 = (i__25867__auto___38641 + (1));
i__25867__auto___38641 = G__38642;
continue;
} else {
}
break;
...
return devtools.formatters.printing.build_markup.cljs$core$IFn$_invoke$arity$variadic((arguments[(0)]),(arguments[(1)]),argseq__25874__auto__);
});
...
devtools.formatters.printing.build_markup.cljs$lang$applyTo = (function (seq38637){
...
return devtools.formatters.printing.build_markup.cljs$core$IFn$_invoke$arity$variadic(G__38638,G__38639,seq38637__$2);
});
...
if(cljs.core.truth_((function (){var or__24791__auto__ = devtools.formatters.helpers.directly_printable_QMARK_.call(null,value);
...
devtools.formatters.printing.TemplateWriter.cljs$lang$ctorPrWriter = (function (this__25397__auto__,writer__25398__auto__,opt__25399__auto__){
return cljs.core._write.call(null,writer__25398__auto__,"devtools.formatters.printing/TemplateWriter");
});
...
if(cljs.core.truth_((function (){var and__24779__auto__ = cljs.core.not.call(null,devtools.formatters.printing.already_reference_QMARK_.call(null,group));
if(and__24779__auto__){
var or__24791__auto__ = devtools.formatters.helpers.expandable_QMARK_.call(null,obj);
if(cljs.core.truth_(or__24791__auto__)){
return or__24791__auto__;
} else {
...
if(cljs.core.truth_(devtools.formatters.helpers.should_render_QMARK_.call(null,new cljs.core.Keyword(null,"render-metas","render-metas",1141294116),value,(function (p1__38643_SHARP_){
return cljs.core.some_QMARK_.call(null,cljs.core.meta.call(null,p1__38643_SHARP_));
})))){
...
var map__38652 = opts;
var map__38652__$1 = ((((!((map__38652 == null)))?((((map__38652.cljs$lang$protocol_mask$partition0$ & (64))) || (map__38652.cljs$core$ISeq$))?true:false):false))?cljs.core.apply.call(null,cljs.core.hash_map,map__38652):map__38652);
var markup_db = cljs.core.get.call(null,map__38652__$1,new cljs.core.Keyword(null,"markup-db","markup-db",812838734));
if(cljs.core.truth_((function (){var or__24791__auto__ = (function (){try{if(!((obj == null))){
...
}catch (e38656){var e__36203__auto__ = e38656;
return false;
}})();
if(cljs.core.truth_(or__24791__auto__)){
return or__24791__auto__;
...
}catch (e38658){var e__36203__auto__ = e38658;
return false;
}}
})())){
...
var _STAR_current_state_STAR_38663 = devtools.formatters.state._STAR_current_state_STAR_;
devtools.formatters.state._STAR_current_state_STAR_ = devtools.formatters.state.get_current_state.call(null);

try{var map__38664 = opts;
var map__38664__$1 = ((((!((map__38664 == null)))?((((map__38664.cljs$lang$protocol_mask$partition0$ & (64))) || (map__38664.cljs$core$ISeq$))?true:false):false))?cljs.core.apply.call(null,cljs.core.hash_map,map__38664):map__38664);
var markup_db = cljs.core.get.call(null,map__38664__$1,new cljs.core.Keyword(null,"markup-db","markup-db",812838734));
...
}finally {devtools.formatters.state._STAR_current_state_STAR_ = _STAR_current_state_STAR_38663;
}});
...
;
var temp__4655__auto___38669 = devtools.formatters.state.get_managed_print_level.call(null);
if(cljs.core.truth_(temp__4655__auto___38669)){
var managed_print_level_38670 = temp__4655__auto___38669;
var _STAR_print_level_STAR_38668_38671 = cljs.core._STAR_print_level_STAR_;
cljs.core._STAR_print_level_STAR_ = managed_print_level_38670;

try{devtools.formatters.state.update_current_state_BANG_.call(null,((function (_STAR_print_level_STAR_38668_38671,managed_print_level_38670,temp__4655__auto___38669,writer,opts,job_fn){
return (function (p1__38666_SHARP_){
return devtools.formatters.state.set_managed_print_level.call(null,p1__38666_SHARP_,null);
});})(_STAR_print_level_STAR_38668_38671,managed_print_level_38670,temp__4655__auto___38669,writer,opts,job_fn))
);

job_fn.call(null);
}finally {cljs.core._STAR_print_level_STAR_ = _STAR_print_level_STAR_38668_38671;
}} else {
job_fn.call(null);
}
...
//# sourceMappingURL=printing.js.map?rel=1481924992125