...
var map__38547 = top_item;
var map__38547__$1 = ((((!((map__38547 == null)))?((((map__38547.cljs$lang$protocol_mask$partition0$ & (64))) || (map__38547.cljs$core$ISeq$))?true:false):false))?cljs.core.apply.call(null,cljs.core.hash_map,map__38547):map__38547);
...
}catch (e38546){var _e = e38546;
return false;
}});
devtools.hints.type_error_to_string = (function devtools$hints$type_error_to_string(self){
var temp__4655__auto___38549 = devtools.hints.get_processed_errors_BANG_.call(null);
if(cljs.core.truth_(temp__4655__auto___38549)){
var seen_errors_38550 = temp__4655__auto___38549;
if(cljs.core.truth_(seen_errors_38550.has(self))){
} else {
seen_errors_38550.add(self);

var temp__4657__auto___38551 = devtools.hints.error_object_sense.call(null,self);
if(cljs.core.truth_(temp__4657__auto___38551)){
var sense_38552 = temp__4657__auto___38551;
self.message = [cljs.core.str(self.message),cljs.core.str(", a sanity hint:\n"),cljs.core.str(sense_38552)].join('');
} else {
}
}
} else {
...
//# sourceMappingURL=hints.js.map?rel=1481854551498