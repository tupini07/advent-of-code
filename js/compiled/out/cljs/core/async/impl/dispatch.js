...
var count_25934 = (0);
while(true){
var m_25935 = cljs.core.async.impl.dispatch.tasks.pop();
if((m_25935 == null)){
} else {
m_25935.call(null);

if((count_25934 < cljs.core.async.impl.dispatch.TASK_BATCH_SIZE)){
var G__25936 = (count_25934 + (1));
count_25934 = G__25936;
continue;
} else {
}
}
